...
let Shoppable = ({image,hotspots}) =>
    `<section class="shoppable show--tapToView">
        <div class="shoppable__container">
            <img class="shoppable__image" src="${image}">
            <div class="hints">
...
render(
    Shoppable,
    {
        ...
        hotspots: [
            ...
            {
                title: "Hario V60-02 Insulated Stainless Steel Server",
                old_price: "19 999 р.",
                new_price: "16 999 р.",
                url: "https://eightouncecoffee.ca/products/hario-v60-02-insulated-stainless-steel-server",
                coordinates: [22,22]
            },
            {
                title: "Hario Matte Black Scoop",
                old_price: "19 999 р.",
                new_price: "16 999 р.",
            ...
            {
                title: "Hario Kasuya Mini Drip Kettle",
                old_price: "19 999 р.",
                new_price: "16 999 р.",
                url: "https://eightouncecoffee.ca/products/hario-matte-black-scoop",
                coordinates: [15,71]
