...
//RANGE
const priceSliderElement = document.querySelector('.droplist-aside-body__slider');
if (priceSliderElement) {
    //создали массив со средним значением
    const getAverageValue = () => {
        let arrayValues = [];
        const maxRange = createPriceSliderElement.options.range.max.join();
        arrayValues.push(+maxRange / 2);
